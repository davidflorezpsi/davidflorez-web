    ...
    servicios: [
      {
        ...
        precio: '$450.000',
        notaPrecio: 'paquete de 3 sesiones',
        btnDetalle: 'Qué incluye y para quién',
        chips: ['Presencial · Bogotá', 'Telepresencial'],
        destacada: true,
        acciones: [
          { label: 'Reservar y pagar', msg: 'Hola, escribo desde la web. Quiero reservar Evaluación Funcional Clínica ($450.000) y recibir el link de pago.', primaria: true },
        ],
        detalle: {
          cejilla: '01 / Evaluación',
          titulo: 'Evaluación Funcional Clínica',
      ...
      },
      {
        ...
        precio: '$1.050.000',
        notaPrecio: '6 sesiones · incluye protocolos',
        btnDetalle: 'Qué incluye y para quién',
      ...
      },
      {
        ...
        desc: 'Ciclo de 16 sesiones de psicoterapia basada en procesos, con objetivos conductuales definidos desde la primera sesión y seguimiento cuantificable del progreso. No es acompañamiento abierto: es un programa con criterios clínicos claros de avance y cierre.',
        precio: '$2.400.000',
        notaPrecio: 'ciclo de 16 sesiones',
        ...
        detalle: {
          ...
          columnas: [
            { titulo: 'Incluye', items: [
              ...
              '4 sesiones de coaching parental integradas al ciclo',
      ...
      },
      {
        ...
        precio: '$1.440.000',
        notaPrecio: 'ciclo de 8 sesiones',
  ...
  },
  {
    ...
    servicios: [
      ...
      },
      {
        ...
        cejilla: '03 / Intervención',
        titulo: 'Programa de Intervención Individual',
        desc: 'Ciclo de 16 sesiones con objetivos conductuales definidos desde la primera sesión y seguimiento cuantificable. Con adolescentes se negocia el encuadre: qué se comparte con los cuidadores y qué queda en el espacio terapéutico.',
        precio: '$2.400.000',
        notaPrecio: 'ciclo de 16 sesiones',
        btnDetalle: 'Qué incluye y cómo se ingresa',
        chips: ['Presencial · Bogotá', 'Telepresencial'],
      ...
      },
      {
        ...
        precio: '$1.680.000',
        notaPrecio: 'ciclo completo · por adolescente',
        btnDetalle: 'Cómo funciona',
        chips: ['Presencial · Bogotá', 'Telepresencial'],
        alterna: true,
        acciones: [
    ...
    servicios: [
      {
        ...
        destacada: true,
        acciones: [
          { label: 'Reservar y pagar', msg: 'Hola, escribo desde la web. Quiero reservar Evaluación Clínica Inicial ($450.000) y recibir el link de pago.', primaria: true },
        ],
        detalle: {
          cejilla: '01 / Evaluación',
          titulo: 'Evaluación Clínica Inicial',
      ...
      },
      {
        ...
        desc: 'Atención breve y focalizada para duelo y eventos traumáticos: estabilización emocional, evaluación de riesgo y una ruta clara de qué sigue.',
        precio: 'se acuerda en la llamada',
        notaPrecio: 'atención breve y focalizada',
        btnDetalle: 'Qué incluye y para quién',
        chips: ['Telepresencial', 'Presencial · Bogotá'],
        alterna: true,
        acciones: [
          { label: 'Reservar y pagar', msg: 'Hola, escribo desde la web. Quiero reservar Intervención en crisis y recibir el link de pago.', primaria: true },
        ],
        detalle: {
          cejilla: '03 / Crisis',
          titulo: 'Intervención en crisis',
          columnas: [
            { titulo: 'Incluye', items: [
              'Contención y estabilización emocional',
              'Evaluación de riesgo',
              'Plan de crisis escrito, con la red de apoyo',
              'Ruta de atención y remisión cuando corresponde',
              'Seguimiento breve acordado',
            ] },
            { titulo: '¿Para quién?', texto: 'Jóvenes de 18 a 25 años en duelo o tras un evento traumático. No es un servicio de urgencias 24 horas: si hay riesgo inmediato para la vida, acude a urgencias o marca la línea 123.' },
          ],
        },
      },
    ],
    ...
    servicios: [
      {
        ...
        precio: 'se acuerda en la llamada',
        notaPrecio: 'según número de sesiones',
        btnDetalle: 'Cómo funciona',
        chips: ['Presencial · Bogotá', 'Telepresencial'],
        destacada: true,
        acciones: [
          { label: 'Reservar y pagar', msg: 'Hola, escribo desde la web. Quiero reservar Coaching parental y recibir el link de pago.', primaria: true },
        ],
        detalle: {
          cejilla: '01 / Familias',
          titulo: 'Coaching parental',
      ...
      },
      {
        ...
        detalle: {
          ...
          columnas: [
            ...
            { titulo: 'Cómo se contrata', texto: 'Escribe por WhatsApp con el alcance que necesitas — número de participantes, modalidad y fechas — y se cotiza a la medida. Los talleres abiertos a familias van a $90.000 por persona. La llamada de orientación gratuita está reservada para familias.' },
          ],
        },
      },
    ],
